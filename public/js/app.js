$(document).ready(function() {
    ...
    if (contact_table_type == 'supplier') {
        ...
        var columns = [
            ...
            { data: 'tot_due', searchable: false, orderable: false },
    ...
    var contact_table = $('#contact_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            var tot_due = sum_table_col($('#contact_table'), 'tot_due');
...
function updateProfitLoss(start = null, end = null, location_id = null) {
    ...
    pl_span.find('.opening_stock, .total_transfer_shipping_charges, .closing_stock, .total_sell, .total_purchase, \.total_expense, .net_profit, .total_adjustment, .total_recovered, .total_sell_discount, \.total_purchase_discount, .total_purchase_return, .total_sell_return, .gross_profit, \.total_reward_amount, .total_payroll, .profit_without_expense, .total_sales_on_cost ').html(loader);
