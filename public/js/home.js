...
function update_statistics(start, end) {
    ...
    $('.total_purchase_due').html(loader);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.total_purchase_due').html(__currency_trans_from_en(data.total_purchase_due, true));
            ...
            $('.total_sell_due').html(__currency_trans_from_en(data.total_sell_due, true));
        },
    });
}
