...
{   
     ...
     * @return void
     */
    public function __construct(RepairUtil $repairUtil, Util $commonUtil, CashRegisterUtil $cashRegisterUtil, ModuleUtil $moduleUtil, ContactUtil $contactUtil, BusinessUtil $businessUtil)
    {
    ...
    {   
        ...
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'repair_module') && $this->moduleUtil->hasThePermissionInSubscription($business_id, 'job_sheets') && (auth()->user()->can('job_sheet.view_assigned') || auth()->user()->can('job_sheet.view_all') || auth()->user()->can('job_sheet.create'))))) {
    ...
    {   
        ...
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'repair_module') && $this->moduleUtil->hasThePermissionInSubscription($business_id, 'add_job_sheet') && auth()->user()->can('job_sheet.create')))) {
            abort(403, 'Unauthorized action.');
        }
        ...
        return view('repair::job_sheet.create')
            ->with(compact('contact_id', 'repair_statuses', 'device_models', 'brands', 'devices', 'default_status', 'technecians', 'business_locations', 'types', 'customer_groups', 'walk_in_customer', 'repair_settings'));
    }
    ...
    public function edit($id)
    {
        ...
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'repair_module') && $this->moduleUtil->hasThePermissionInSubscription($business_id, 'job_sheets') && auth()->user()->can('job_sheet.edit')))) {
            abort(403, 'Unauthorized action.');
        }
    ...
    public function destroy($id)
    {
        ...
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'repair_module') && $this->moduleUtil->hasThePermissionInSubscription($business_id, 'job_sheets') && auth()->user()->can('job_sheet.delete')))) {
            abort(403, 'Unauthorized action.');
        }
    ...
    {   
        ...
        if (!(auth()->user()->can('superadmin') || ($this->moduleUtil->hasThePermissionInSubscription($business_id, 'repair_module') && $this->moduleUtil->hasThePermissionInSubscription($business_id, 'job_sheets') && (auth()->user()->can('job_sheet.create') || auth()->user()->can('job_sheet.edit'))))) {
            abort(403, 'Unauthorized action.');
        }
