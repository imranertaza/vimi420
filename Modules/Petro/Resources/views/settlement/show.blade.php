                        ...
                        <div class="col-md-12">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{@num_format($settlement->total_amount)}}
                                        </td>
                                        ...
                                        <td class="text-right">{{@num_format($settlement->total_amount + $settlement->card_payments->sum('amount') + $settlement->cheque_payments->sum('amount') + $settlement->credit_sale_payments->sum('amount') + $settlement->expense_payments->sum('amount') + $settlement->shortage_payments->sum('amount') + $settlement->excess_payments->sum('amount'))}}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
