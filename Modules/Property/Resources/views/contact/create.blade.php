    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div>
          ...
          <div
            class="col-md-3  @if($type=='customer' && !array_key_exists('property_customer_custom_field_4', $contact_fields)) hide @endif @if($type=='supplier' && !array_key_exists('supplier_custom_field_4', $contact_fields)) hide @endif">
            <div class="form-group">
