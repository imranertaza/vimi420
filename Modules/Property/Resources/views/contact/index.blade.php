        ...
        <table class="table table-bordered table-striped" id="property_contact_table">
            <thead>
                ...
                <tr>
                    ...
                    @endif
                    @if($type=='customer' && !array_key_exists('property_customer_custom_field_3', $contact_fields))
                    <th>
                        @lang('lang_v1.contact_custom_field3')
                    </th>
                    @endif
                    @if($type=='customer' && !array_key_exists('property_customer_custom_field_4', $contact_fields))
                    <th>
