            ...
            <div class="col-md-7">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        __('property::lang.finance_option'), 'required']); !!}
    ...
    <div class="border-top">
        <div class="col-md-12 payment_row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 text-red text-right " style="font-size: 23px; font-weight: bold">
                    @lang('property::lang.total_amount'): <span class="total_amount">0.00</span>
                </div>
                <div class="col-md-3 text-right" style="font-size: 23px; font-weight: bold">
    ...
    $('#date').datepicker('setDate', new Date());
        ...
        $(document).on('click', '.add_payment_row', function(){
            ...
            $('#payment_table tbody').append(
                `<tr>
                    ...
                    <td>${bank_name}</td>
                    <td>${card_number}</td>
                    <td>${__number_f(amount)}</td>
                </tr>`
            )
            $('.payment_data').append(
                `
                <input type="hidden" name="payment[${row_id}][payment_option_id]" value="${payment_option}">
                <input type="hidden" name="payment[${row_id}][amount]" value="${amount}">
                <input type="hidden" name="payment[${row_id}][method]" value="${payment_method}">
                <input type="hidden" name="payment[${row_id}][account_id]" value="${account_id}">
                <input type="hidden" name="payment[${row_id}][card_number]" value="">
                <input type="hidden" name="payment[${row_id}][card_transaction_number]" value="">
                <input type="hidden" name="payment[${row_id}][card_holder_name]" value="${card_holder_name}">
                <input type="hidden" name="payment[${row_id}][card_type]" value="${card_type}">
                <input type="hidden" name="payment[${row_id}][card_year]" value="${card_year}">
                <input type="hidden" name="payment[${row_id}][card_month]" value="${card_month}">
                <input type="hidden" name="payment[${row_id}][card_security]" value="${card_security}">
                <input type="hidden" name="payment[${row_id}][cheque_number]" value="${cheque_number}">
                <input type="hidden" name="payment[${row_id}][cheque_date]" value="${cheque_date}">
                <input type="hidden" name="payment[${row_id}][bank_name]" value="${bank_name}">
        ...
        $('.add_block_purchase').click(function(){
            ...
            $('.block_data').append(
                ...
                <input type="hidden" name="sell_line[${block_row_id}][block_value]" value="${block_value}">
                `
            )
