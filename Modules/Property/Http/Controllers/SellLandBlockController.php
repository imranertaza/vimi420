...
class SellLandBlockController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction_data['total_before_tax'] = $this->productUtil->num_uf($transaction_data['total_block_value'], $currency_details) * $exchange_rate;


            $transaction_data['tax_amount'] = 0;
            $transaction_data['shipping_charges'] = 0;
            $transaction_data['final_total'] = $this->productUtil->num_uf($transaction_data['total_block_value'], $currency_details) * $exchange_rate;
    ...
    public function createSellAccountTransactions($transaction)
    {
