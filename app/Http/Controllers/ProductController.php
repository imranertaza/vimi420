...

{
            ...
            return Datatables::of($products)
                ...
                ->addColumn(
                    ...
                    '<div style="white-space: nowrap;">
                        <span class="display_currency selling_price" data-currency_symbol="true" data-orig-value=""></span> 
                        <?php
                            echo ( ((float)$min_purchase_price) != "" ) ? (float)$min_purchase_price : 0.00 ;
                        ?>
                        @if($max_purchase_price != $min_purchase_price && $type == "variable") 
                ...
                ->addColumn(
                    ...
                    '<div style="white-space: nowrap;">
                        <span class="display_currency selling_price" data-currency_symbol="true"></span> 
                        <?php
                            echo ( ((float)$min_price) != "" ) ? (float)$min_price : 0.00 ;
                        ?>
                        @if($max_price != $min_price && $type == "variable") 
                        -  <span class="display_currency" data-currency_symbol="true">
                                {{$max_price}}
                            </span>
                        @endif 
...

    {
        ...
        try {
            ...
            $form_fields = ['name', 'stock_type', 'brand_id', 'unit_id', 'category_id', 'tax', 'type', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 'product_custom_field3', 'product_custom_field4', 'product_description', 'sub_unit_ids'];
...

    {
        ...
        return view('product.edit')
            ...
            ->with(compact('accounts', 'categories', 'brands', 'units', 'sub_units', 'taxes', 'tax_attributes', 'barcode_types', 'product', 'sub_categories', 'default_profit_percent', 'business_locations', 'rack_details', 'selling_price_group_count', 'module_form_parts', 'product_types', 'common_settings', 'warranties'));
...

    {
        ...
        try {
            ...
            $product_details = $request->only(['type', 'name', 'stock_type', 'brand_id', 'unit_id', 'category_id', 'tax', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 'product_custom_field3', 'product_custom_field4', 'product_description', 'sub_unit_ids']);
