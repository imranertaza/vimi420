$(document).ready(function () {
    ...
    if ($('#purchase_sell_date_filter').length == 1) {
        ...
        $('#purchase_sell_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#purchase_sell_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
        updatePurchaseSell();
    }
    ...
    if ($('#trending_product_date_range').length == 1) {
        ...
        $('#trending_product_date_range').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#trending_product_date_range').data('daterangepicker').setEndDate(moment().endOf('month'));
    ...
    if ($('#close_date').length == 1) {
        ...
        $('#close_date').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#close_date').data('daterangepicker').setEndDate(moment().endOf('month'));
    ...
    if ($('#sr_date_filter').length == 1) {
        ...
        $('#sr_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#sr_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
    ...
    if ($('#profit_loss_date_filter').length == 1) {
        ...
        $('#profit_loss_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#profit_loss_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
        updateProfitLoss();
    }
    ...
    if ($('#product_pr_date_filter').length == 1) {
        ...
        $('#product_pr_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#product_pr_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
    }
    $(
        '#product_purchase_report_form #purchase_variation_id, #product_purchase_report_form #purhcase_location_id, #product_purchase_report_form #purchase_category_id, #product_purchase_report_form #purchase_sub_category_id, #product_purchase_report_form #purhcase_supplier_id, #product_purchase_report_form #product_pr_date_filter'
    ).change(function () {
        product_purchase_report.ajax.reload();
    });
    $('#product_purchase_report_form #purchase_search_product').keyup(function () {
        if ($(this).val().trim() == '') {
            $('#product_purchase_report_form #purchase_variation_id').val('').change();
        }
    });
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function (d) {
                ...
                d.start_date = start;
                d.end_date = end;
                d.variation_id = $('#purchase_variation_id').val();
    ...
    if ($('#purchase_search_product').length > 0) {
        $('#purchase_search_product').autocomplete({
            ...
            minLength: 2,
            select: function (event, ui) {
                $('#purchase_variation_id').val(ui.item.value).change();
                event.preventDefault();
                $(this).val(ui.item.label);
            },
            focus: function (event, ui) {
    ...
    if ($('#sell_search_product').length > 0) {
        $('#sell_search_product').autocomplete({
            ...
            minLength: 2,
            select: function (event, ui) {
                $('#sell_variation_id').val(ui.item.value).change();
                event.preventDefault();
                $(this).val(ui.item.label);
            },
            focus: function (event, ui) {
    ...
    if ($('#product_sr_date_filter').length == 1) {
        ...
        $('#product_sr_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#product_sr_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
    }
    product_sell_report = $('table#product_sell_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function (d) {
                ...
                d.variation_id = $('#sell_variation_id').val();
    ...
    $(
        '#sell_variation_id, #sell_location_id, #sell_customer_id, #sell_category_id, #sell_sub_category_id, #sell_location_id'
    ).change(function () {
        product_sell_report.ajax.reload();
        product_sell_grouped_report.ajax.reload();
    });
    ...
    if ($('#ppr_date_filter').length == 1) {
        ...
        $('#ppr_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#ppr_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
    }
    ...
    if ($('#spr_date_filter').length == 1) {
        ...
        $('#spr_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#spr_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
    }
    ...
    if ($('#ir_purchase_date_filter').length == 1) {
        ...
        $('#ir_purchase_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#ir_purchase_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
    }
    if ($('#ir_sale_date_filter').length == 1) {
        ...
        $('#ir_sale_date_filter').data('daterangepicker').setStartDate(moment().startOf('month'));
        $('#ir_sale_date_filter').data('daterangepicker').setEndDate(moment().endOf('month'));
    }
