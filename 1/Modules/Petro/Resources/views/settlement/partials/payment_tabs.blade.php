    ...
    <div class="col-sm-12">
        <div class="settlement_tabs">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#cash_tab" class="cash_tab" data-toggle="tab">
                ...
                <li>
                    <a href="#cards_tab" class="cards_tab" style="" data-toggle="tab">
                ...
                <li>
                    <a href="#cheques_tab" class="cheques_tab" style="" data-toggle="tab">
                ...
                <li>
                    <a href="#expense_tab" class="expense_tab" style="" data-toggle="tab">
                ...
                <li>
                    <a href="#shortage_tab" class="shortage_tab" style="" data-toggle="tab">
                ...
                <li>
                    <a href="#excess_tab" class="excess_tab" style="" data-toggle="tab">
                ...
                <li>
                    <a href="#credit_sales_tab" class="credit_sales_tab" style="" data-toggle="tab">
