  ...
  <div class="">
    <div class="col-md-8 col-lg-8 ">
      <div class="row">
        ...
        <div class="col-md-6">
          <input name="display" class="form-control input-lg amount input_number" style="margin-top: 10px; background: #fff; border: 2px solid #333;" id="amount"
            value="" />
  ...
  <div class="row">
        ...
        <div class="row">
          <div class="btn-group-vertical" >
            ...
            <label class="payment_type_btn btn btn-large btn-flat btn-block btn-warning">
              <input class="payment_type_checkbox" type="checkbox" name="payment_type" value="credit"
                autocomplete="off"> @lang('petro::lang.credit')
            </label>
            <label class="payment_type_btn btn btn-large btn-flat btn-block btn-success">
              <input class="payment_type_checkbox" type="checkbox" name="payment_type" value="multiple_credit"
                autocomplete="off"> @lang('petro::lang.multiple_credit')
            </label>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-3">
      <div class="row">
        ...
        <a href="{{action('\Modules\Petro\Http\Controllers\PumpOperatorController@dashboard')}}"><input
            value="Dashboard" class="btn btn-flat btn-lg btn-block" style="color: #fff;background-color:#810040;"
            type="button" />
        </a>
        <br /><br /><br />
        <button value="save" id="payment_submit" name="submit" class="btn btn-flat btn-lg btn-block"
          style="color: #fff; background-color:#2874A6;" type="button">@lang('lang_v1.save') </button>
        <br /><br /><br />
        <span onclick="reset()">
          <button type="button" class="btn btn-flat btn-lg btn-block" style="color: #fff; background-color:#CC0000;"
            type="button"> <i class="fa fa-refresh" aria-hidden="true"></i> @lang('petro::lang.cancel') </button>
        </span>
        <br>
        <br>
        <a href="{{action('Auth\PumpOperatorLoginController@logout')}}" class="btn btn-flat btn-block btn-lg pull-right"
