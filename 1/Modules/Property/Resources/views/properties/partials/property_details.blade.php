<section class="content">
    ...
    <div class="col-md-3">
        <div class="form-group">
            {!! Form::label('property_details_block_id',  __('purchase.supplier') . ':') !!}
            {!! Form::select('property_details_block_id', $blocks, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            {!! Form::label('property_details_finance_option_id',  __('property::lang.finance_option') . ':') !!}
