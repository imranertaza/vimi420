			...
			<div class="box-body">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="checkbox">
							<label>
								{!! Form::checkbox('contact_module', 1, $packages->contact_module, ['class' =>
                                'input-icheck']); !!}
					...
					<div class="col-sm-3">
						<div class="checkbox">
							<label>
								{!! Form::checkbox('contact_supplier', 1, $packages->contact_supplier, ['class' =>
                                'input-icheck']); !!}
					...
					<div class="col-sm-3">
						<div class="checkbox">
							<label>
								{!! Form::checkbox('contact_customer', 1, $packages->contact_customer, ['class' =>
                                'input-icheck']); !!}
					...
					<div class="col-sm-3">
						<div class="checkbox">
							<label>
								{!! Form::checkbox('report_module', 1, $packages->report_module, ['class' =>
                                'input-icheck']); !!}
