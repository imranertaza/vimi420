...
class PackagesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input['contact_module'] = $request->contact_module == '1' ? 1 : 0;
            ...
            $input['report_module'] = $request->report_module == '1' ? 1 : 0;
            ...
            if ($request->sale_module == '1') {
                $packages_details['all_sales'] = 1;
                $packages_details['add_sale'] = 1;
                $packages_details['list_pos'] = 1;
                $packages_details['list_draft'] = 1;
                $packages_details['list_quotation'] = 1;
                $packages_details['list_sell_return'] = 1;
                $packages_details['shipment'] = 1;
                $packages_details['discount'] = 1;
            }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin::packages.edit')
            ->with(compact('packages', 'intervals', 'permissions', 'currencies'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->petro_module == '1') {
                $packages_details['petro_module'] = 1;
                $packages_details['meter_resetting'] = 1;
            } else {
            ...
            $packages_details['contact_module'] = $request->contact_module == '1' ? 1 : 0;
            ...
            $packages_details['report_module'] = $request->report_module == '1' ? 1 : 0;
