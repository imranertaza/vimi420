...
class TransactionPaymentController extends Controller
{
     ...
     * @return void
     */
    public function __construct(TransactionUtil $transactionUtil, ModuleUtil $moduleUtil, Util $util)
    {
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('transaction_payment.edit_payment_row')
                ->with(compact('transaction', 'payment_types', 'payment_line', 'accounts', 'expense_accounts'));
        }
    }
        ...
        if (request()->ajax()) {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                $view = view('transaction_payment.payment_row')
                    ->with(compact('transaction', 'payment_types', 'account_module', 'payment_line', 'amount_formated', 'accounts'))->render();
    ...
    public function getChequeDropdownByBankId($bank_id, $contact_id)
    {
         ...
         * @Task 3353
         */
        $html = $this->util->createDropdownHtml($array, 'Please Select');
