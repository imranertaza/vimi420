...

{
        ...
        if ($request->ajax()) {
            ...
            $datatable =  DataTables::of($products)
                ...
                ->addColumn(
                    ...
                    '<span class="display_currency due" data-currency_symbol="true" data-orig-value="{{$final_total - $total_paid}}">{{$final_total - $total_paid}}</span>'
...

    {
        ...
        return view('customer_statement.partials.print_statement_header')->with(compact('contact', 'ledger_details', 'business_details', 'for_pdf', 'location_details', 'statement_no'));
