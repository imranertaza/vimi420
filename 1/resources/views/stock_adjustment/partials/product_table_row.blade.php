<tr class="product_row">
    ...
    <td>
        <select name="products[{{$row_index}}][addjustment_type]" id="addjustment_type" class="form-control select2">
    ...
    <td>
        <input type="text" name="products[{{$row_index}}][unit_price]" class="form-control product_unit_price input_number" value="{{@num_format($product->last_purchased_price)}}" style="width: 130px;">
    </td>
    <td>
        <input type="text" readonly name="products[{{$row_index}}][price]" class="form-control product_line_total" value="{{@num_format(!empty($temp_qty)?$temp_qty*$product->last_purchased_price:$product->quantity_ordered*$product->last_purchased_price)}}">
    </td>
