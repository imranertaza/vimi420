      ...
      <div class="row payment_row">
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select("method", $payment_types, $method, ['class' => 'form-control select2 payment_types_dropdown', 'required', 'style' => 'width:100%;','disabled' => true]); !!}
        ...
        <div class="col-sm-6">
					...
					<div class="form-group">
						...
						{!! Form::select('expense_account', $expense_accounts, !empty($transaction->expense_account) ? $transaction->expense_account : null, ['class' => 'form-control select2', 'placeholder' => __('lang_v1.please_select'),'disabled' => true]) !!}
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::select("account_id", $accounts, !empty($payment_line->account_id) ? $payment_line->account_id : '' , ['class' => 'form-control select2', 'id' => "account_id", 'style' => 'width:100%;','disabled' => true]); !!}
