...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-4 equal-column  @if($product->enable_stock == 0) hide @endif"
              id="raw_material_div">
              <div class="form-group">
                <br>
                  {!! Form::label('stock_type', __('product.stock_type'), []) !!}
                {!! Form::select('stock_type', $accounts, $product->stock_type, ['class' => 'form-control select2', 'id' => 'stock_type', 'required', 'placeholder' => __('product.please_select')]) !!}
        ...
        @if(session('business.enable_product_expiry'))
          ...
          <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('show_avai_qty_in_qr_catalogue', 1,  $product->show_avai_qty_in_qr_catalogue, [ 'class' => 'input-icheck']); !!} <strong> {{ __( 'lang_v1.show_avai_qty_in_qr_catalogue' ) }} </strong>
                  </label>
                </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('show_in_catalogue_page', 1,  $product->show_in_catalogue_page, [ 'class' => 'input-icheck']); !!} <strong> {{ __( 'lang_v1.show_in_catalogue_page' ) }} </strong>
                  </label>
                </div>
            </div>
          </div>
    ...
    @if(auth()->user()->can('product.price_section'))
      @component('components.widget', ['class' => 'box-primary'])
    @else
