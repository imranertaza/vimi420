                ...
                <li class=" @if(session('status.tab') == 'customer-payments') active @endif">
                    ...
                    <a href="#customer_payments" data-toggle="tab">
                        ...
                        <i class="fa fa-list"></i> <strong>
                            ...
                            @lang('lang_v1.customer_payments') </strong>
...
@section('javascript')
    ...
    <script>
        ...
        $('#customer_payment_date_range, #customer_payment_location_id, #customer_payment_customer_id, #customer_payment_method, #paid_in_type').change(function () {
