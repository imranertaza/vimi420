<div class="payment_details_div @if( $payment_line->method !== 'card' ) {{ 'hide' }} @endif" data-type="card" >
	...
	<div class="col-md-4">
		...
		<div class="form-group">
			...
			{!! Form::text("card_number", $payment_line->card_number, ['class' => 'form-control', 'placeholder' => __('lang_v1.card_no'),'disabled' => true]); !!}
	...
	<div class="col-md-4">
		...
		<div class="form-group">
			...
			{!! Form::text("card_holder_name", $payment_line->card_holder_name, ['class' => 'form-control', 'placeholder' => __('lang_v1.card_holder_name'),'disabled' => true]); !!}
	...
	<div class="col-md-4">
		...
		<div class="form-group">
			...
			{!! Form::text("card_transaction_number", $payment_line->card_transaction_number, ['class' => 'form-control', 'placeholder' => __('lang_v1.card_transaction_no'),'disabled' => true]); !!}
	...
	<div class="col-md-3">
		...
		<div class="form-group">
			...
			{!! Form::select("card_type", ['credit' => 'Credit Card', 'debit' => 'Debit Card', 'visa' => 'Visa', 'master' => 'MasterCard'], $payment_line->card_type,['class' => 'form-control select2','disabled' => true]); !!}
	...
	<div class="col-md-3">
		...
		<div class="form-group">
			...
			{!! Form::text("card_month", $payment_line->card_month, ['class' => 'form-control', 'placeholder' => __('lang_v1.month') ,'disabled' => true]); !!}
	...
	<div class="col-md-3">
		...
		<div class="form-group">
			...
			{!! Form::text("card_year", $payment_line->card_year, ['class' => 'form-control', 'placeholder' => __('lang_v1.year') ,'disabled' => true]); !!}
	...
	<div class="col-md-3">
		...
		<div class="form-group">
			...
			{!! Form::text("card_security", $payment_line->card_security, ['class' => 'form-control', 'placeholder' => __('lang_v1.security_code'),'disabled' => true]); !!}
...
<div class="payment_details_div @if( $payment_line->method !== 'cheque' && $payment_line->method !== 'bank_transfer' ) {{ 'hide' }} @endif" data-type="cheque" >
	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			{!! Form::text("cheque_number", $payment_line->cheque_number, ['class' => 'form-control', 'placeholder' => __('lang_v1.cheque_no'),'disabled' => true]); !!}
	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			{!! Form::text("cheque_date", $payment_line->cheque_date, ['class' => 'form-control cheque_date', 'placeholder' => __('lang_v1.cheque_date'),'disabled' => true]); !!}
