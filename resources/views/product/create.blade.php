...
<section class="content">
  ...
  <div class="row">
    ...
    $last_sku = DB::table('products')->select('id','sku')->where('business_id', $business_id)->orderBy('id',
    'desc')->first();
    if(empty($sku_prefix)){
    $sku_prefix = '';
    }
    ...
    <div class="col-sm-4 equal-column">
      <div class="form-group">
        {!! Form::label('sku', __('product.sku') . ':') !!} @if(!empty($help_explanations['sku'])) @show_tooltip($help_explanations['sku']) @endif
    ...
    <div class="col-sm-4 equal-column">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          session('business.default_unit'), ['class' => 'form-control select2', 'required', 'id' => 'unit_id']); !!}
    ...
    <div class="col-sm-4 equal-column @if(!session('business.enable_sub_units')) hide @endif">
      <div class="form-group">
        ...
        @if(!empty($help_explanations['related_sub_units'])) @show_tooltip($help_explanations['related_sub_units']) @endif
    ...
    <div
      class="col-sm-4 equal-column @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
      <div class="form-group">
    ...
    <div class="col-sm-4 equal-column">
      <div class="form-group">
        ...
        @if(!empty($help_explanations['business_location'])) @show_tooltip($help_explanations['business_location']) @endif
    ...
    <div class="col-sm-4 equal-column @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif"
      id="alert_quantity_div">
      <div class="form-group">
        {!! Form::label('alert_quantity', __('product.alert_quantity') . ':') !!}
        @if(!empty($help_explanations['alert_quantity'])) @show_tooltip($help_explanations['alert_quantity']) @endif
    ...
    <div class="col-sm-4 equal-column">
      <div class="form-group">
        ...
        </label> @if(!empty($help_explanations['manage_stock'])) @show_tooltip($help_explanations['manage_stock']) @endif <p class="help-block">
    ...
    <div class="col-sm-4 equal-column  @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif"
      ...
      <div class="form-group">
        <br>
          {!! Form::label('stock_type', __('product.stock_type'), []) !!} @if(!empty($help_explanations['stock_account_names'])) @show_tooltip($help_explanations['stock_account_names']) @endif
        {!! Form::select('stock_type', $accounts, null, ['class' => 'form-control select2', 'id' => 'stock_type', 'required', 'placeholder' => __('product.please_select')]) !!}
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        </label> @if(!empty($help_explanations['enable_product_description_imei'])) @show_tooltip($help_explanations['enable_product_description_imei']) @endif 
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        </label> @if(!empty($help_explanations['not_for_selling'])) @show_tooltip($help_explanations['not_for_selling']) @endif
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="form-group">
          <div class="checkbox">
            <label>
              {!! Form::checkbox('show_avai_qty_in_qr_catalogue', 1, false, [ 'class' => 'input-icheck']); !!} <strong> {{ __( 'lang_v1.show_avai_qty_in_qr_catalogue' ) }} </strong>
            </label>
          </div>
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="form-group">
          <div class="checkbox">
            <label>
              {!! Form::checkbox('show_in_catalogue_page', 1, false, [ 'class' => 'input-icheck']); !!} <strong> {{ __( 'lang_v1.show_in_catalogue_page' ) }} </strong>
            </label>
          </div>
      </div>
    </div>
    ...
    <div class="col-md-12">
      <h4>@lang('lang_v1.rack_details'):
        @if(!empty($help_explanations['rack_row_position_details'])) @show_tooltip($help_explanations['rack_row_position_details']) @endif
      </h4>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('type', __('product.product_type') . ':*') !!} @if(!empty($help_explanations['product_type'])) @show_tooltip($help_explanations['product_type']) @endif
