        ...
        <div class="col-md-12">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('customer_payment_bulk_payment_ref_no', null, ['class' => 'form-control',
                    'placeholder' => __('lang_v1.payment_ref_no'), 'style' => 'width: 100%;']); !!}
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="payment_data_row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        !!}
                        {!! Form::select('customer_payment_bulk_payment_method',['cash' => 'Cash', 'card' => 'Card',
                        'cheque' =>
